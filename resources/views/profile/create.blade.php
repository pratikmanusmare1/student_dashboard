    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="bi bi-person-plus"></i> Create Profile</h2>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('year_of_passing') is-invalid @enderror" 
                                   id="year_of_passing" name="year_of_passing" value="{{ old('year_of_passing') }}" 
                                   min="1950" max="{{ date('Y') }}">
                        ...
                        <div class="mb-0">
                            ...
                            <input type="text" class="form-control @error('university_institute') is-invalid @enderror" 
                                   id="university_institute" name="university_institute" value="{{ old('university_institute') }}">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('current_organization') is-invalid @enderror" 
                                   id="current_organization" name="current_organization" value="{{ old('current_organization') }}">
                        ...
                        <div class="mb-0">
                            ...
                            <textarea class="form-control @error('skills') is-invalid @enderror" 
                                      ...
                                      placeholder="e.g., JavaScript, Python, Communication, Leadership">{{ old('skills') }}</textarea>
                            @error('skills')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
